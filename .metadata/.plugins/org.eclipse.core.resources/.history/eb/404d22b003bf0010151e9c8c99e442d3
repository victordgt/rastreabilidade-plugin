...
public class CasoDeUsoView extends ViewPart {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "rastreabilidade.plugin.views.casodeuso.CasoDeUsoView";
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				CasoDeUsoView.this.fillContextMenu(manager);
			}
		});
